...
if(NOT DEFINED OBS_VERSION_OVERRIDE AND EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.git")
  execute_process(
    COMMAND git describe --always --tags --dirty=-modified --match "[0-9]*.[0-9]*.[0-9]*"
  ...
  if(_obs_version_result EQUAL 0)
    if(_obs_version MATCHES "([0-9]+)\\.([0-9]+)\\.([0-9]+).*")
      ...
      message(
        WARNING
        "Ignoring non-semver git tag '${_obs_version}' for OBS versioning; "
        "falling back to default version ${_obs_default_version}."
      )
      set(_obs_version ${_obs_default_version})
    endif()
  endif()
